    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Instructors",
                columns: new[] { "Id", "ApplicationUserId", "Department", "Email", "FirstName", "LastName" },
                values: new object[,]
                {
                    { 1, null, "BIOC", "blah@blah.gov", "Carlos", "Lopez" },
                    { 2, null, "PSYC", "gav@blah.gov", "Gavin", "Hensley" },
                    { 3, null, "MATH", "great@blah.gov", "Davis", "Murphy" }
                });

            migrationBuilder.InsertData(
                table: "Students",
                columns: new[] { "Id", "AcademicStanding", "Email", "FirstName", "LastName", "PreferredName" },
                values: new object[,]
                {
                    { 1, "5th Year", "darius@blah.gov", "Darius", "Hammond", null },
                    { 2, "Senior", "rimma@blah.gov", "Rimma", "Girsheva", null }
                });
